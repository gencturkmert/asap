...
parameters_dict = {
    ...
    'c_normalization': {
          'values': ['local_z_score', 'local_min_max', 'batch_norm', 'layer_norm', 'group_norm', 'instance_norm', 'local_robust_scaling',
                     'global_z_score', 'global_min_max','global_robust_scaling', 'box_cox', "yeo_johnson",
                     'default']
        }
    }
...
sweep_id = wandb.sweep(sweep_config, project="hepatisis_test_v1")
#sweep_id = "6e6zmlgd" # to continue a sweep
import time
